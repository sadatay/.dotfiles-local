;;; earthsong-theme.el --- an Emacs 24 theme based on Earthsong (tmTheme)
;;
...
;;  from Earthsong (tmTheme) by
;;
;;; Code:

(deftheme earthsong
  "earthsong-theme - Created by tmtheme-to-deftheme - 2017-09-03 22:03:08 -0500")
...
(custom-theme-set-faces
 ...
 ;; Temporary defaults
 '(linum                               ((t (:foreground "#5a5148"  :background "#48413a" ))))
 '(fringe                              ((t (                       :background "#48413a" ))))
 ...
 '(mode-line-inactive                  ((t (:foreground "#d9a776"  :background "#48413a" :box nil :weight light :inherit (mode-line)   ))))
 '(mode-line                           ((t (:foreground "#ebd1b7"  :background "#48413a" :box nil ))))
